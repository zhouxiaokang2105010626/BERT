...
model = BertModel.from_pretrained('D://bert//bert-base-uncased')
tokenizer = BertTokenizer.from_pretrained('D://bert//bert-base-uncased')

# 从CSV文件中加载数据，这里使用的是APIs.csv文件，可以根据需要注释掉APIs.csv并取消注释Mashups.csv
# data = pd.read_csv("datasets/Cleaned/Mashups.csv", encoding='iso-8859-1')  # 使用Mashups.csv文件
data = pd.read_csv("datasets/Cleaned/APIs.csv", encoding='iso-8859-1')  # 使用APIs.csv文件
